...
namespace FBC_SIMIRIT
{
    public class Calendar
    {
        ...
        public DateTime dateConvert(string H)
        {
            String y = (H.Split('/')[0]).ToString();
            String l = Convert.ToInt16(H.Split('/')[1]).ToString();
            String v = Convert.ToInt16(H.Split('/')[2]).ToString();

            String j = y + "/" + l + "/" + v;
            DateTime K = EthiopicToGregorian(j);
        ...
        public virtual string GregorianToEthiopic(DateTime gcDate)
        {
            ...
            var result = string.Format("{0}-{1}-{2}", date[0], date[1], date[2]);
            return result;
        }
    ...
    public class EthiopicDateTime
    {
        ...
        public EthiopicDateTime(DateTime gcDateTime)
        {
            ...
            _incomingEra = FBC_SIMIRIT.Calendar.JD_EPOCH_OFFSET_AMETE_MIHRET;
